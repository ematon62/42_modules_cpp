...
/*   Updated: 2025/06/05 15:36:16 by ematon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	std::cout << std::endl;
	std::cout << "\033[1;31mFragTrap\033[0m\n";
	{
	FragTrap bb;
	...
	std::cout << std::endl;
	std::cout << "\033[1;31mCopies de FragTrap\033[0m\n";
	{
	FragTrap jerem("jerem");
	jerem.takeDamage(20);
